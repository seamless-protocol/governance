...
library Constants {
    ...
    uint48 public constant GOVERNOR_LONG_VOTING_DELAY = 2 * 7200; // 2 days
    uint32 public constant GOVERNOR_LONG_VOTING_PERIOD = 17280; // 3 days
    uint256 public constant GOVERNOR_LONG_PROPOSAL_THRESHOLD = 0;
