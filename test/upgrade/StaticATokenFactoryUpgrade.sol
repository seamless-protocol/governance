...
import {IPool, DataTypes} from 'staticLib/aave-helpers/lib/aave-address-book/src/AaveV3.sol';
 ...
 * @author BGD labs
 */
contract StaticATokenFactoryUpgrade is Initializable, IStaticATokenFactory {
